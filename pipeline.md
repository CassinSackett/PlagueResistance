...
## II. Outlier FST
I am more confident that my candidates are real when using several different programs to detect outliers. 
...
:warning: My outflank output produced ~1000 inferred outliers, but when I look at allele frequencies at those SNPs in the two groups, they were indistinguishable. I decided not to use this analysis. 
...
You can theoretically get this in an R package, but the strategy of using brute force :weight_lifter:  in bash gives consistent, manipulable results.
